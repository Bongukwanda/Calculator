...
Calculator's a small instrument that has made basic calculations and even complex ones a bit easier on the mind.

## Project Objective
This project serves to display a simple program using python as the main language, to display Graphic User Interface(GUI) programming abilities - focusing on Python Tkinter as the interfac, and then backend functions such as calculations, to be done in python, encoporating basic list, strings and basic functionality in python.
